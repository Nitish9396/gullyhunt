    ...
    <div className={styles.page}>
          ...
          <div className={styles.phones}>
            ...
            <div className={`${styles.phone} ${styles.phoneCenter}`}>
              ...
              <div className={styles.phoneContent}>
                ...
                <div className={styles.phMap}>
                  ...
                  <span className={styles.phPin}
                    style={{ top: "30%", left: "40%" }}>🏏</span>
                  <span className={styles.phPin}
                    style={{ top: "55%", left: "60%" }}>⚽</span>
                  <span className={styles.phPin}
                    style={{ top: "20%", left: "65%" }}>🏸</span>
                </div>
                <div className={styles.phCard}>
                ...
                <button className={styles.phBtn} onClick={() => navigate("/find")}>
                  Find Games
                </button>
              </div>
            </div>
            ...
            <div className={styles.phone}>
              ...
              <div className={styles.phoneContent}>
                ...
                <button className={styles.phBtn} onClick={() => navigate("/post")}>
                  Post Match
                </button>
              </div>
            </div>
          ...
          {[
            {
              ...
              desc: "Enter the city you are in or tap to use your GPS. GullyHunt instantly shows all live and upcoming games near you.",
            },
            {
              n: "02", icon: "🔍", title: "Filter and Find",
              desc: "Filter by sport, time, entry fee and skill level. See who is organizing and how many spots are left.",
            },
            {
              n: "03", icon: "✅", title: "Join and Play",
              desc: "Tap Join, get the organizer contact on WhatsApp, bring your kit and show up. Just play.",
            },
          ].map((s) => (
        ...
        <div className={styles.roles}>
          {[
            ...
            { icon: "🏟️", title: "Turf Owner", color: "var(--neon2)",
              desc: "List your turf, manage slot bookings and connect with players." },
            { icon: "🏛️", title: "Stadium", color: "var(--blue)",
              desc: "Post events, grow your player base citywide. Academies and stadiums welcome." },
          ].map((r) => (
            <div
              key={r.title}
        ...
        <div className={styles.roadmap}>
          {[
            { icon: "🗺️", title: "Live Map View",
              status: "In Development", sc: "var(--neon)",
              desc: "See all games on an interactive map. Find matches within 5km using GPS." },
            { icon: "💳", title: "Online Payments",
              status: "In Development", sc: "var(--blue)",
              desc: "Pay entry fees via UPI, Card or Netbanking. Instant confirmation." },
            { icon: "📱", title: "Mobile App",
              status: "Coming Soon", sc: "var(--orange)",
              desc: "Native Android and iOS app with push notifications." },
            { icon: "⭐", title: "Ratings and Reviews",
              status: "Planned", sc: "var(--pink)",
              desc: "Rate organizers and venues. Build community trust." },
            { icon: "🏆", title: "Tournaments",
              status: "Planned", sc: "var(--neon2)",
              desc: "Full tournament brackets, group stages and live scoreboards." },
            { icon: "💬", title: "Team Chat",
              status: "Planned", sc: "var(--neon)",
              desc: "Chat with your team before the match. Coordinate pickups and kit." },
          ].map((r) => (
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerCopy}>
          2026 GullyHunt. Made with love for India.
        </div>
      </footer>
